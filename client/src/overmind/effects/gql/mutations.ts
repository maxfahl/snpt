...
export const updateSnippetGroup = gql`
    mutation UpdateSnippetGroup($snippetGroupId: Int!, $fields: UpdateSnippetGroupInput!) {
...
export const updateSnippetVariableSet = gql`
    mutation UpdateSnippetVariableSet($snippetVariableSetId: Int!, $fields: UpdateSnippetVariableSetInput!) {
        updateSnippetVariableSet(snippetVariableSetId: $snippetVariableSetId, fields: $fields) {
            id,
            name
        }
    }
